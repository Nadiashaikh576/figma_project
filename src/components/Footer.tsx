    ...
    <div className="bg-gray-100 py-16 text-gray-600">
      ...
      <div className="mt-12 border-t border-gray-200 pt-8">
        <div className="flex justify-between items-center w-[90%] mx-auto">
          <p className="text-gray-500">&copy; Webecy - All Rights Reserved. Nadia Shaikh</p>
          <div className="flex space-x-4">
            <a href="https://www.facebook.com/nadiashaikh189?mibextid=ZbWKwL" className="w-8 h-8 rounded-full bg-[#151875] flex items-center justify-center text-white hover:bg-blue-700">
              <FaFacebookF />
            </a>
            <a href="https://x.com/IntelliverseHub?s=09" className="w-8 h-8 rounded-full bg-[#151875] flex items-center justify-center text-white hover:bg-blue-700">
              <FaTwitter />
            </a>
            <a href="https://www.instagram.com/nadiashaikh189?igsh=bTFsaXphNGI2cDk=" className="w-8 h-8 rounded-full bg-[#151875] flex items-center justify-center text-white hover:bg-blue-700">
              <FaInstagram />
            </a>
          </div>
        </div>
