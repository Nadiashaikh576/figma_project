...
function Hero() {
  ...
  return (
    <div className="relative bg-gray-100 py-10 md:py-20 px-5 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
      ...
      <div className="w-full md:w-1/2 h-full flex flex-col md:flex-row items-center justify-start pl-6 md:pl-16 relative">
        ...
        {/* Bulb Image */}
<div className="relative md:absolute top-[-122px] left-[-20px] md:left-[-100px]">
  <Image src="/images/bulb.png" alt="Bulb" width={250} height={250} className="object-contain" />
</div>
